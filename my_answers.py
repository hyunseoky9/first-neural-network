...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        hidden_error_term = hidden_error*output_error_term*hidden_outputs[:,None]*(1-hidden_outputs[:,None])
        print(hidden_error_term)
        # Weight step (input to hidden)
        delta_weights_i_h += X[:,None]*hidden_error_term.transpose()
    ...
    def run(self, features):
        ...
        hidden_outputs = self.activation_function(np.matmul(features,self.weights_input_to_hidden)) # signals from hidden layer
